const locale = {
    ...
    wallet_create: {
        ...
        step1: {
            ...
            error: {
                ...
                account_should_start_with_a_letter: '주소는 영문문자부터 시작해야 합니다.',
                account_format_error: '주소는 영문문자,숫자 또는 -를 포함하여 만드셔야 합니다.',
                account_one_dash_error: '-한번만 사용 가능',
                account_end_error: '주소는 영문문자 또는 숫자로 끝나야 합니다.',
                account_segment_should_be_longer: '주소는 너무 짧습니다.-전후 3자리를 초과해서 입력해주세요',
                premium_name: '사용하고 있는 주소는 고급 주소라 다른 주소 선택해주세요.최소 -하나,숫자 하나 또는 모음을 않 포함하는 주소를 입력해주세요.'
            },
            next: '다음'
        },
        step2: {
            ...
            error: {
                ...
                account_has_been_registered: '중복된 주소 입니다. 주소를 다시 입력해주세요',
    ...
    wallet_import: {
        ...
        error: {
            ...
            no_reference_account: '임포트 실패했습니다!개인키와 맞는 주소가 존재하지 않습니다.'
        },
        success: {
            title: '임포트 성공',
            tip1: '지갑 임포트가 성공했습니다',
            tip2: '개인키 분실되면은 다시 못 찾으니까 사용전에 개인키를 백업하시길 바랍니다!',
            backup_wallet: '개인키 백업',
            detail: '지갑 열기'
        }
    },
    ...
    wallet_backup: {
        index: {
            ...
            tip: '앱 삭제 후 다른 휴대폰에서 지갑을 사용 시,사용하고 있는 지갑의 개인키를 임포트하셔야 되니까 개인키를 백업하시길 바랍니다.아니면 지갑 자산 영구적으로 분실될 것이다.백업한 지갑 정보를 잘 보관하시길 바랍니다.',
            label: {
                account: '지갑주소',
                asset: '지갑 자산(GXC)',
                private_key: '개인키'
        ...
        detail: {
            title: '개인키를 백업',
            tip: '백업을 쉽게 하기 위해 지갑주소는 하기와 같이 문자열로 되는 개인키로 암호화됐습니다.이 개인키를 백업하면 지갑이 되찾아올 수 있습니다.',
            tip1: '순서대로 개인키를 종이에다 적으셔서 잘 보관합니다',
            tip2: '누군가 개인키정보를 얻으면 지갑의 자금을 조작할 수 있습니다.',
            tip3: '휴대폰이 캐시를 정리하거나 응용을 삭제하면 개인키가 분실될 수 있습니다.개인키를 분실하면 지갑의 자금을 영구적으로 찾지 못합니다！',
            unlock: '잠금해제',
            copy: '개인키 복사',
            copied: '복사 완료',
            cancel: '취소',
    ...
    wallet_del: {
        ...
        cancel: '취소',
        ok: '확인',
        tip_del: '지갑이 잠금해제하고 삭제하기.조작은 취소를 할 수 없습니다.삭제하시겠습니까？',
        placeholder: {
            password: '지갑 비밀번호를 입력해주세요.'
        },
        error: {
    ...
    disclaimer: {
        title: '면책조항',
        content: '<h4 class="text-center">사용지침 및 면책조항</h4>' +
    ...
    transfer: {
        ...
        error: {
            amount: {
                ...
                insufficient_balance: '잔액이 부족합니다.잔액은 송금금액+수수료보다 많은 것을 확인해주세요',
                insufficient_diff_balance: '잔액이 부족합니다.잔액은 송금금액보다 많은 것을 확인해주세요',
            ...
            account: {
                ...
                account_should_start_with_a_letter: '주소는 영문문자로  시작되어야 합니다.',
                account_format_error: '주소는 영문、 숫자 또는 - 로 구성되어야합니다',
                account_one_dash_error: '-한번만 사용가능',
                account_end_error: '주소는 영문문자나 숫자로 끝내야 합니다',
                account_segment_should_be_longer: '아이디가 너무 짧습니다. -전후 3자리이상으로 입력해주세요',
                premium_name: '고급 주소를 사용하고 있으니 최소 -하나,숫자 하나 또는 모음을 않 포함하는 주소를 입력해주세요',
                memo_signer_not_exist: '개인키가 존재하지 않습니다.비고는 추가할 수 없습니다.'
            }
        },
        confirm: {
            title: '송금 확인',
    ...
    loyalty_program: {
        ...
        tip3: '충성계획은 GXChain가 출시한 복리계획입니다.투자자는 일정한 금액의 GXC를 잠글 수 있습니다.잠금 기간에 자금 동결 동시에 해당 보상을 받을 수 있습니다.예를 들어 GXC 1만 개를 9개월 동안에 잠그면 연간이자율 6%으로 하여 자금 잠금해제 시 GXC 450개 보상을 얻을 수 있습니다 .GXChain는 투자자가 충성계획을 통해 앞으로 GXChain가 발전하는 것에 자져온  장기적인 이익을 누릴수 있는 것을 원합니다！',
        ...
        button_join: '충성계획 가입해서  <span class="big">{bonus}</span>% 벌 수 있습니다.',
        placeholder: {
            amount: '잠금 금액을 입력해주세요 '
        },
        modal: {
            message: '충성계획을 가입하는 금액이 잠그될 것이니 그 기간에 팔지 못합니다.해당 조작은 취소할 수 없습니다.가입을 확인하시겠습니까？',
            cancel: '취소',
            confirm: '확인',
