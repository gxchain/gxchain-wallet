    ...
    <div class="page-group">
        <div class="page" id="page-wallet-create-success">
            <header class="bar bar-nav">
                <h3 class="title">{{$t('nft.successful')}}</h3>
            ...
            <div class="content">
                <div class="center-content">
                    <div class="content-block">
                        ...
                        <p class="text-center text-success">{{$t('nft.successful')}}</p>
                    </div>
                </div>
                <div class="content-block button-block">
                    <p>
                        <router-link :to="link('/')" replace class="button button-gxb">{{$t('transfer.success.done')}}</router-link>
                    </p>
                </div>
            </div>
        </div>
