            ...
            <div class="content" v-show="unlocked">
                <div class="nav-box">
                    ...
                    <div class="account">
                        ...
                        <div class="to">
                            <account-image :account="toAccount" :size='14'></account-image>
                            {{toAccount}}
                        </div>
                ...
                <div class="description">
                    {{$t('transactionConfirm.transfer')}}&nbsp;&nbsp;{{amountStr}}
                </div>
                <!--info-panel-->
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            this.amount = this.extra.amount;
            this.toAccount = this.extra.to;
            this.memo = this.extra.memo || '';
            this.amountStr = this.extra.originalArgs.amountStr;
