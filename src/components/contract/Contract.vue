            ...
            <div class="content" v-show="unlocked && plugin === 'contract'">
                ...
                <div class="info-box">
                    ...
                    <div class="tab-container" v-show="currentTab === 2">
                        <div class="func-type">{{$t('smart_contract.params.method_type')}}:
                            <span>Method: {{methodName}}</span></div>
                        <div class="hex-data">
                            ...
                            <ul>
                                <li class="item-content">
                                    <div class="item-inner">
                                        <div class="item-title">{{$t('oauth.authorize.confirm_tip1')}} <span
                                                class="highlight">{{$t('oauth.authorize.current_app')}}</span>
                                            {{$t('oauth.authorize.confirm_tip2')}}
                                        </div>
                                    </div>
                                </li>
                                <li class="item-content">
